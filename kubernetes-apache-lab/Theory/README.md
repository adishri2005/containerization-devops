<div align="center">
  <img src="https://kubernetes.io/images/nav_logo.svg" alt="Kubernetes Logo" width="300" />
  <br/>
...
### Phase 2: Deployments & High Availability 🛡️
...
| **Misconfigurations** | 🛡️ Kubernetes gracefully isolates failures (e.g., bad images), maintaining the availability of previous replicas. |
